...
if(CLR_CMAKE_HOST_OS STREQUAL linux)
    ...
    if(CLR_CROSS_COMPONENTS_BUILD)
        ...
        elseif(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL i686)
            ...
            clr_unknown_arch("${CMAKE_HOST_SYSTEM_PROCESSOR}")
        endif()
    else()
        ...
        elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL mips64)
            ...
            clr_unknown_arch("${CMAKE_SYSTEM_PROCESSOR}")
        endif()
    endif()
...
if(CLR_CMAKE_HOST_OS STREQUAL darwin)
    ...
    elseif(CMAKE_OSX_ARCHITECTURES STREQUAL arm64)
        ...
        clr_unknown_arch("${CMAKE_OSX_ARCHITECTURES}")
    endif()
...
elseif(WIN32)
    ...
    if (NOT CLR_CMAKE_HOST_ARCH)
        set(CLR_CMAKE_HOST_ARCH ${LOWERCASE_CMAKE_SYSTEM_PROCESSOR})
    endif()

    if(CLR_CMAKE_HOST_ARCH MATCHES "^(x64|amd64)$")
        set(CLR_CMAKE_HOST_ARCH_AMD64 1)
    ...
    elseif(CLR_CMAKE_HOST_ARCH STREQUAL arm64)
        ...
        clr_unknown_arch("${CLR_CMAKE_HOST_ARCH}")
    endif()
endif()
...
if(NOT DEFINED CLR_CMAKE_TARGET_ARCH OR CLR_CMAKE_TARGET_ARCH STREQUAL "" )
  if(CLR_CMAKE_HOST_ARCH)
    set(CLR_CMAKE_TARGET_ARCH ${CLR_CMAKE_HOST_ARCH})
  else()
    set(CLR_CMAKE_TARGET_ARCH ${CMAKE_SYSTEM_PROCESSOR})
  endif()
