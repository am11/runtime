...
public sealed class GeneratedRegexAttribute : Attribute
{
    ...
    public GeneratedRegexAttribute([StringSyntax(StringSyntaxAttribute.Regex, "options")] string pattern, RegexOptions options) : this (pattern, options, Timeout.Infinite)
    {
    }
