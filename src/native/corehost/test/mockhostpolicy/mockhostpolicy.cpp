...
SHARED_API int HOSTPOLICY_CALLTYPE corehost_load(host_interface_t* init)
{
    ...
    trace::verbose(PAL_X("--- Invoked hostpolicy mock - corehost_load"));
...
{
    trace::verbose(PAL_X("--- Invoked hostpolicy mock - corehost_main"));
    return StatusCode::Success;
}

SHARED_API int HOSTPOLICY_CALLTYPE corehost_unload()
{
    trace::verbose(PAL_X("--- Invoked hostpolicy mock - corehost_unload"));
    return StatusCode::Success;
}

SHARED_API corehost_error_writer_fn HOSTPOLICY_CALLTYPE corehost_set_error_writer(corehost_error_writer_fn error_writer)
{
    trace::verbose(PAL_X("--- Invoked hostpolicy mock - corehost_set_error_writer"));
    return nullptr;
}
