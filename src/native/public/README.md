...
return type, changing the layout of defined non-opaque structs, changing the calling convention,
etc. may potentially break existing clients and should not be undertaken lightly.
